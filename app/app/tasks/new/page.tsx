      ...
      <div className="fd-reveal rounded-xl border bg-white p-4 sm:p-6">
        ...
        <form action={createTask} className="space-y-4">
          <div className="space-y-1">
            ...
            <input id="title" name="title" required placeholder="Ex: Enviar proposta" className="w-full rounded-md border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-400 transition" />
          </div>
