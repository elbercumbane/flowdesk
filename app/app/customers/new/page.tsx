        ...
        <form action={createCustomer} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select id="status" name="status" className="w-full rounded-md border px-3 py-2 text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input id="email" name="email" type="email" className="w-full rounded-md border px-3 py-2 text-sm" />
            </div>
            <div className="space-y-1">
              <label htmlFor="phone" className="text-sm font-medium">Telefone</label>
              <input id="phone" name="phone" className="w-full rounded-md border px-3 py-2 text-sm" />
            </div>
          </div>
